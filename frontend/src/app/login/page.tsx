  ...
  return (
    <div className="max-w-md mx-auto mt-12">
      <div className="text-center mb-6">
        ...
        <p className="text-[color:rgb(var(--text-muted-rgb))]">Sign in to your account</p>
      </div>
      ...
      <div className="bg-[color:rgb(var(--card-rgb))] rounded-xl shadow-md border border-[color:rgb(var(--border-rgb))] p-8">
        ...
        <div className="mt-6 text-center">
          <p className="text-[color:rgb(var(--text-muted-rgb))]">
            ...
            <Link href="/signup" className="text-[color:rgb(var(--primary-rgb))] hover:underline font-medium">
              Sign up
            </Link>
          </p>
        </div>
